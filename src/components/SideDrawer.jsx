...
const SideDrawer = () => {
  ...
  const accessChat = async (userId) => {
    ...
    try {
      ...
      const { data } = await axios.post(`https://me-chat-backend.onrender.com/api/chats`, { userId }, config);
  ...
  const removeNotification = async (id) => {
    try {
      ...
      await axios.delete(`https://me-chat-backend.onrender.com/api/notification/${id}`, config);
    } catch (err) {
      toast.error(err);
    }
  };
  const getPrevNotification = async () => {
    try {
      ...
      const { data } = await axios.get("https://me-chat-backend.onrender.com/api/notification", config);
